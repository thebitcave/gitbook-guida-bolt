...
In questa lezione andremo a creare una semplice applicazione che andrà a scrivere del testo all'interno della console. In particolare andremo a creare una _Flow Machine_ ed inseriremo un semplice comando di scrittura.
